...
const Activity = {
  ...
  async create(activityData) {
    ...
    const item = {
      ...
      hasAccommodation: activityData.hasAccommodation !== false,
      campingRate: activityData.hasAccommodation !== false ? activityData.campingRate || 0 : 0,
      roomsRate: activityData.hasAccommodation !== false ? activityData.roomsRate || 0 : 0,
      charetsRate: activityData.hasAccommodation !== false ? activityData.charetsRate || 0 : 0,
      airportPickupAvailable: activityData.airportPickupAvailable !== false,
      airportPickupRate: activityData.airportPickupAvailable !== false ? activityData.airportPickupRate || 7.5 : 0,
      mealIncluded: activityData.mealIncluded === true,
